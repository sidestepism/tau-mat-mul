...
void gemm(mat <M0,K0> a, mat<K0,N0> b, mat<M0,N0> c, long an0, long an1, long am0, long am1, long bn0, long bn1, long bm0, long bm1)
{
  ...
  if(M*N + N*K + M*K < 4096) {
    ...
    // 中点
    long am2 = (am0 + am1)/2;        
    gemm(a, b, c, an0, an1, am0, am2, bn0, bn1, bm0, bm1);
    gemm(a, b, c, an0, an1, am2, am1, bn0, bn1, bm0, bm1);
  }else if(N >= M && N >= K){
    // 中点
    long bn2 = (bn0 + bn1)/2;
    gemm(a, b, c, an0, an1, am0, am1, bn0, bn2, bm0, bm1);
    gemm(a, b, c, an0, an1, am0, am1, bn2, bn1, bm0, bm1);
  }else{
    // 中点
    long an2 = (an0 + an1)/2;
    long bm2 = (bm0 + bm1)/2;
    gemm(a, b, c, an0, an2, am0, am1, bn0, bn1, bm0, bm2);
    gemm(a, b, c, an2, an1, am0, am1, bn0, bn1, bm2, bm1);
  }
}
